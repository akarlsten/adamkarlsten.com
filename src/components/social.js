  ...
  return (
    <IconContext.Provider value={{ className: 'social__icon' }}>
      <div className="social">
        ...
        <a className="social__link" href={`https://github.com/${social.github}`} target="_blank" rel="noopener noreferrer">
          <p>{social.github}</p> <FaGithub />
        </a>
        <a className="social__link" href={`https://twitter.com/${social.twitter}`} target="_blank" rel="noopener noreferrer">
